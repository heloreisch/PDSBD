...
public class Estudante {
 ...
 // Estudante NOVO: o id fica 0 porque quem gera o id e o banco.// Estudante NOVO: o id fica 0 porque quem gera o id e o banco.
 ...
 // Estudante que VEIO do banco: o id ja existe.
    ...
    public String toString() {
        return String.format(
            "Estudante[id=%d, nome=%s, curso=%s, nota=%.1f]",
            id, nome, curso, nota
        );
    }
}